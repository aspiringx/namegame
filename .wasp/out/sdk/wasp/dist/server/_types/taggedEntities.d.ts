import { type Entity, type EntityName, type User, type UserUser, type Group, type GroupUser, type Code, type Photo, type Message, type Greeting, type IceBreaker, type Link } from 'wasp/entities';
...
export type _Entity = _User | _UserUser | _Group | _GroupUser | _Code | _Photo | _Message | _Greeting | _IceBreaker | _Link | never;
