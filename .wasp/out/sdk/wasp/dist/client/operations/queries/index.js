...
// PUBLIC API
export const getGroup = createQuery('operations/get-group', ['Group']);
// PUBLIC API
...
// PUBLIC API
export const getMessage = createQuery('operations/get-message', ['Message', 'User']);
// PUBLIC API
export const getMessages = createQuery('operations/get-messages', ['Message', 'User']);
// PUBLIC API
export const getGreeting = createQuery('operations/get-greeting', ['Greeting', 'User']);
// PUBLIC API
export const getGreetings = createQuery('operations/get-greetings', ['Greeting', 'User']);
// PUBLIC API
export const getIceBreaker = createQuery('operations/get-ice-breaker', ['IceBreaker', 'Group']);
// PUBLIC API
export const getIceBreakers = createQuery('operations/get-ice-breakers', ['IceBreaker', 'Group']);
