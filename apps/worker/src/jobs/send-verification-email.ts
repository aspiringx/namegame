    ...
    <html>
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
          <p style="font-size: 14px; line-height: 24px;">Hi ${firstName || ''},</p>
          <p style="font-size: 14px; line-height: 24px;">
            You've joined a NameGame group! Please click this link to verify your email address and unlock features.
          </p>
          ...
          <p style="font-size: 14px; line-height: 24px; background-color: #fef3c7; padding: 12px; font-weight: bold;">
            NOTICE: Be sure to open this link in the same browser you used to save this email address in your NameGame user profile.
          </p>
          <p style="font-size: 14px; line-height: 24px;">
 ...
 */
export const sendVerificationEmail: JobHandler<SendVerificationEmailPayload> = async (payload) => {
  console.log('[Job:send-verification-email] Processing verification email job', {
    email: payload.email,
  ...
  console.log('[Job:send-verification-email] Verification email sent successfully', {
    email: payload.email,
  });
};
