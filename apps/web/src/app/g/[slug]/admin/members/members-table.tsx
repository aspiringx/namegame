      ...
      <div className="mt-8 flow-root">
        <div className="-my-2">
          <div className="inline-block min-w-full py-2 align-middle">
            <table className="min-w-full table-fixed divide-y divide-gray-300 sm:table divide-gray-700">
              <thead className="hidden sm:table-header-group">
                <tr>
                  ...
                  <th
                    scope="col"
                    className="w-1/4 px-2 py-3.5 text-left text-sm font-semibold text-gray-900 text-white"
                  >
                    Roles
                  </th>
                  <th
              ...
              <tbody className="block divide-y divide-gray-200 sm:table-row-group divide-gray-800">
                {groupUsers.map((groupUser) => (
                  <tr
                    key={groupUser.userId}
                    className="flex flex-wrap items-start justify-between border-b border-gray-200 p-2 sm:table-row sm:p-0 border-gray-800"
                  >
                    <td className="w-5/6 py-2 pr-2 sm:table-cell sm:w-auto sm:py-4 sm:pr-3 sm:pl-0">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4 flex-1">
                          ...
                          <div className="break-all text-gray-500 sm:max-w-[25ch] sm:truncate text-gray-400">
                            {groupUser.user.email}
                          </div>
                          <div className="text-sm text-gray-500 sm:hidden text-gray-400">
                            {groupUser.role.code}
                          </div>
