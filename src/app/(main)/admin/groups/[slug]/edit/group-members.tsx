                  ...
                  <form action={handleAddMember} className="min-w-[320px]">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        placeholder="YYYY"
                        className="block w-24 rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 focus:outline-none sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                      />
                      <select
                        name="roleId"
                        defaultValue={
                          groupUserRoles.find((r) => r.code === 'member')?.id
                        }
                        className="block w-full rounded-md border-gray-300 py-2 pr-10 pl-3 text-base focus:border-indigo-500 focus:ring-indigo-500 focus:outline-none sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                      >
                        {groupUserRoles
                          .filter(
                            (role) =>
                      ...
                      <button
                        type="submit"
                        disabled={isAdding}
                        className="inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-3 py-2 text-sm leading-4 font-medium text-white shadow-sm hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none disabled:opacity-50"
                      >
                        {isAdding ? 'Adding...' : 'Add'}
                      </button>
                    </div>
