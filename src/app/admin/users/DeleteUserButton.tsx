      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/25 backdrop-blur-sm flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md">
            ...
            <p className="mb-6 text-wrap text-left">Are you sure? Soft-deleting will disable the user while hard-deleting will permanently remove it, but may fail if other relationships depend on it.</p>
