...
interface GroupToolbarProps {
  ...
  handleSort: (key: 'joined' | 'firstName' | 'lastName') => void
...
export default function GroupToolbar({
  ...
  const activeFilters = []
  if (settings.filterConnectedStatus && settings.filterConnectedStatus !== 'all') {
    activeFilters.push(
    ...
    <div className="my-2 flex items-center justify-between">
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuRadioGroup
                ...
                onValueChange={(value) =>
                  setSettings((prev) => ({
                    ...prev,
                    filterConnectedStatus:
                      value as 'all' | 'connected' | 'not_connected',
                  }))
                }
              >
                <DropdownMenuRadioItem
      ...
      <div className="flex items-center gap-1">
        ...
        <Button
          ...
          size="sm"
          onClick={() => setSettings((prev) => ({ ...prev, viewMode: 'tree' }))}
